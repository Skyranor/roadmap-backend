...
### 💬 ЧТО СПРОСЯТ НА ИНТЕРВЬЮ (Месяц 1)
...
## МЕСЯЦ 2
### SQL Basics + NestJS Skeleton + Drizzle
...
### 💬 ЧТО СПРОСЯТ НА ИНТЕРВЬЮ (Месяц 2)
...
## МЕСЯЦ 3
### SQL Advanced + NestJS Architecture
...
### 💬 ЧТО СПРОСЯТ НА ИНТЕРВЬЮ (Месяц 3)
...
### 💬 ЧТО СПРОСЯТ НА ИНТЕРВЬЮ (Месяц 4)
...
### 💬 ЧТО СПРОСЯТ НА ИНТЕРВЬЮ (Месяц 5)
...
### 💬 ЧТО СПРОСЯТ НА ИНТЕРВЬЮ (Месяц 6)
...
## МЕСЯЦ 7
### AI/LLM Integration — Omnia становится AI-native
...
### 💬 ЧТО СПРОСЯТ НА ИНТЕРВЬЮ (Месяц 7)
...
### ⏸️ БУФЕРНАЯ НЕДЕЛЯ (после месяца 7)
...
### 💬 ЧТО СПРОСЯТ НА ИНТЕРВЬЮ (Месяц 8)
...
## МЕСЯЦ 9
### Docker + CI/CD + Architecture Patterns
...
### 💬 ЧТО СПРОСЯТ НА ИНТЕРВЬЮ (Месяц 9)
...
### 💬 ЧТО СПРОСЯТ НА ИНТЕРВЬЮ (Месяц 10)
...
│                    NestJS API                                │
│  ┌──────────┐ ┌──────────┐ ┌──────────┐ ┌──────────────┐   │
│  │  Auth    │ │  Users   │ │Workspaces│ │  AI Module   │   │
│  │  Module  │ │  Module  │ │  Module  │ │  (Agent,RAG) │   │
│  └──────────┘ └──────────┘ └──────────┘ └──────────────┘   │
│  ┌──────────┐ ┌──────────┐ ┌──────────┐ ┌──────────────┐   │
│  │  Files   │ │  Audit   │ │  Cache   │ │   BullMQ     │   │
│  │  Module  │ │  Module  │ │  Module  │ │   Queues     │   │
│  └──────────┘ └──────────┘ └──────────┘ └──────────────┘   │
│                                                              │
│  Pino (structured logs) · Prometheus (/metrics) · OTel      │
└───────┬─────────────┬──────────────┬──────────────┬─────────┘
        │             │              │              │
   ┌────▼────┐  ┌─────▼─────┐  ┌────▼────┐  ┌─────▼─────┐
   │PostgreSQL│  │   Redis   │  │  MinIO  │  │  OpenAI   │
   │+ Drizzle│  │ cache/pub │  │   (S3)  │  │    API    │
   │+ pgvector│  │ /sub/rate │  │         │  │           │
   └─────────┘  └───────────┘  └─────────┘  └───────────┘

   ┌──────────┐  ┌───────────┐  ┌─────────┐
   │Prometheus│  │  Grafana  │  │  Jaeger │
   │ scraping │  │dashboards │  │ tracing │
   └──────────┘  └───────────┘  └─────────┘
```
